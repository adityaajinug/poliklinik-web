                            ...
                            <tbody>
                                @forelse ($data as $index => $dokter)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="border-b border-gray-300 px-4 py-3 text-gray-700">{{ $dokter->nama }}</td>
                                        <td class="border-b border-gray-300 px-4 py-3 text-gray-700">{{ $dokter->alamat }}</td>
                                        <td class="border-b border-gray-300 px-4 py-3 text-gray-700">{{ $dokter->no_hp }}</td>
